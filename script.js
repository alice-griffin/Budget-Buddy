...
const expenseDescription = document.getElementById(
    "purchase-information-description"
);
...
class BudgetBuddy {
    ...
    submitBudgetInput() {
        this.budgetSubmitForm.addEventListener("submit", (event) => {
            ...
            this.balanceRemaining = Number.parseFloat(
                data.get("budget-input")
            ).toFixed(2);
    ...
    submitExpense() {
        purchaseInfoForm.addEventListener("submit", (event) => {
            ...
            const itemPrice = parseFloat(expensePrice.value);
            newData2.innerText = "$" + (itemPrice).toFixed(2);
            ...
            if (selectedType === "Bills") {
                ...
                bills.innerText =
                    "Total Bills: " + "$" + parseFloat(this.billsExpenses).toFixed(2);
                ...
                food.innerText =
                    "Total Food: " + "$" + parseFloat(this.foodExpenses).toFixed(2);
                ...
                entertainment.innerText =
                    "Total Entertainment: " +
                    "$" +
                    parseFloat(this.entertainmentExpenses).toFixed(2);
                ...
                clothing.innerText =
                    "Total Clothing: " +
                    "$" +
                    parseFloat(this.clothingExpenses).toFixed(2);
